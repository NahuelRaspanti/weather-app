...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom */ \"./src/dom.js\");\n\n\ndocument.addEventListener('click', (event) => {\n    const searchInput = document.querySelector('#search');\n    const searchResults = document.querySelector('.results');\n\n    if (!searchInput.contains(event.target) && !searchResults.contains(event.target)) {\n        searchResults.style.display = 'none';\n    }\n});\n\nconst initHandlers = () => {\n    document.querySelector('#search').addEventListener('keyup', (event) => {\n        if(event.key == 'Enter' && event.target.value) {\n            (0,_dom__WEBPACK_IMPORTED_MODULE_0__.render)(event.target.value);\n        }\n        else if (event.target.value){\n            let timerId;\n            clearTimeout(timerId);\n                timerId = setTimeout(() => {\n                  (0,_dom__WEBPACK_IMPORTED_MODULE_0__.renderSearch)(event.target.value);\n            }, 300);\n        }\n        \n        event.stopPropagation();\n    });\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initHandlers);\n\n//# sourceURL=webpack://weather-app/./src/handler.js?");
